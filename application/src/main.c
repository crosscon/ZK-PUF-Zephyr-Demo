...
int main(void)
{
    ...
    ipc_shm.size  = (uint64_t)VMS_IPC_PAYLOAD_SIZE;     // total available size
    ...
    LOG_INF("PUF_TA_INIT called");

    k_msleep(500);

    /* PUF_TA_get_commitment */
    arg.func = PUF_TA_GET_COMMITMENT_FUNC_ID;
    ...
    LOG_INF("PUF_TA_GET_COMMITMENT called");

    k_msleep(500);

    /* PUF_TA_get_zk_proofs_func_id */
    arg.func = PUF_TA_GET_ZK_PROOFS_FUNC_ID;
    ...
    LOG_INF("PUF_TA_GET_ZK_PROOFS called");
